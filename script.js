...
if(pontos==3){
    ...
    caixaPerguntas.textContent = "MEDALHA DE BRONZE";
}

    
if (pontos==4){
    caixaPrincipal.style.backgroundImage = "url('img/prata.png')";
    caixaPerguntas.textContent = "MEDALHA DE PRATA";
}
if (pontos==5){
    caixaPrincipal.style.backgroundImage = "url('img/ouro.png')";
    caixaPerguntas.textContent = "MEDALHA DE OURO"
    
}
if (pontos==3){
caixaPrincipal.style.backgroundImage = "url('img/perdeu.png')";
caixaPerguntas.textContent = "SEM MEDALHAS"
}
